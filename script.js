/**
 * Global Variable & Multi-language Support Initialization
 */
let currentLang = "EN";
const translations = {
  EN: {
    ...
    back_to_info: "Back to personal info",
...
function applyTheme(theme) {
  const attrKey = theme === "dark" ? "switch_light" : "switch_dark";
  toggleIcons.forEach((btn) => {
    btn.setAttribute("data-i18n-aria-label", attrKey);
    btn.setAttribute("data-i18n-title", attrKey);
  });
...
function updateLanguage(lang) {
  ...
  // 1.1 Support custom data-i18n placeholder, aria-label and title translations
