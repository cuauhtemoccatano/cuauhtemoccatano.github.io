...
const translations = {
  EN: {
    ...
    scan_url_label: "Enter website URL for brand scan",
  ...
  ES: {
    ...
    scan_url_label: "Ingresa la URL del sitio web para el análisis de marca",
    oracle_toggle: "Abrir asistente de IA El Oráculo",
