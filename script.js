/**
 * Multi-language Support Logic & Translation Database (Loaded at Top)
 */
let currentLang = "EN";
const translations = {
  EN: {
    ...
    scan_now_label: "Scan website vital statistics",
    scan_url_label: "Website URL for brand vitality analysis",
    oracle_input_label: "Type message for the Oracle",
    close_modal: "Close booking modal",
    github_label: "GitHub Profile",
    linkedin_label: "LinkedIn Profile",
    instagram_label: "Instagram Profile",
    suite_select_label: "Select digital service"
  },
  ES: {
    ...
    close_oracle: "Cerrar Asistente Oráculo",
    send_message: "Enviar mensaje",
    oracle_toggle: "Abrir Asistente Oráculo",
    back_to_info: "Volver a información de contacto",
    terminal_input_label: "Entrada de comando de la terminal",
    nav_toggle: "Abrir menú de navegación",
    lang_switch_label: "Cambiar idioma",
    scan_now_label: "Escanear estadísticas vitales del sitio",
    scan_url_label: "URL del sitio web para análisis de vitalidad",
    oracle_input_label: "Escribe un mensaje para el Oráculo",
    close_modal: "Cerrar ventana de reserva",
    github_label: "Perfil de GitHub",
    linkedin_label: "Perfil de LinkedIn",
    instagram_label: "Perfil de Instagram",
    suite_select_label: "Seleccionar servicio digital"
  }
};
...
function applyTheme(theme) {
  const nextKey = theme === "dark" ? "switch_light" : "switch_dark";
  ...
  if (t && t[nextKey]) {
    toggleIcons.forEach((btn) => {
      btn.setAttribute("aria-label", t[nextKey]);
      btn.setAttribute("title", t[nextKey]);
    });
  }
...
/**
 * Multi-language Support Logic Execution
 */
...
function updateLanguage(lang) {
  ...
  // 1.5. Localize placeholders, aria-labels, and titles
