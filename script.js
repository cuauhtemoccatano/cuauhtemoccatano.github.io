...
toggleIcons.forEach((toggle) => {
  toggle.addEventListener("click", () => {
    ...
    // Sync ARIA labels with localized text
    const langKey = nextTheme === "dark" ? "switch_light" : "switch_dark";
    const nextText = translations[currentLang][langKey];
...
const translations = {
  ...
  ES: {
    ...
    oracle_input_label: "Enviar mensaje al Oráculo",
...
function updateLanguage(lang) {
  ...
  // 2. Multi-Attribute Localization
