...
function updateLanguage(lang) {
  ...
  document.getElementById("oracle-toggle")?.setAttribute("aria-label", t.oracle_toggle);
  document.getElementById("oracle-toggle")?.setAttribute("title", t.oracle_toggle);
  document.getElementById("close-oracle")?.setAttribute("aria-label", t.close_oracle);
  document.getElementById("close-oracle")?.setAttribute("title", t.close_oracle);
  document.getElementById("send-oracle")?.setAttribute("aria-label", t.send_message);
  document.getElementById("send-oracle")?.setAttribute("title", t.send_message);
  document.getElementById("backToStep1")?.setAttribute("aria-label", t.back_to_info);
  document.getElementById("backToStep1")?.setAttribute("title", t.back_to_info);
