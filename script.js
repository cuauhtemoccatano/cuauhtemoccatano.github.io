...
toggleIcons.forEach((toggle) => {
  toggle.addEventListener("click", () => {
    ...
    const nextText = nextTheme === "dark" ? (translations[currentLang]?.switch_light || "Switch to light mode") : (translations[currentLang]?.switch_dark || "Switch to dark mode");
...
function updateLanguage(lang) {
  ...
  // Additional data-i18n attributes for accessibility
